...
<div class="signup-form">
    <form action="{{route('user-register')}}" method="post" onsubmit="return validate">
		@csrf
		<h2>Register</h2>
		<p class="hint-text">Create your account. It's free and only takes a minute.</p>
		@if($message  = Session::get('success'))
		<p class="alert alert-success alert-block">your account has been successfully created</p>
		@endif
		...
		<div class="form-group">
            <input type="password" class="form-control" name="confirm_password" id="confirm_password"  placeholder="Confirm Password" onkeyup="check(this)">
	...
	<div class="text-center">Already have an account? <a href="user-login">Sign in</a></div>
</div>
</body>
