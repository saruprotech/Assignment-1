...
<h4 class="pt-sm-2 pb-1 mb-0 text-nowrap">Shrawan Verma</h4>
<p class="mb-0">saru@gmail.com</p>
<div class="text-muted"><small>Last seen-:</small></div>
<div class="mt-2">
...
<div class="text-muted"><small>Joined 04 Aug 2023</small></div>
</div>
</div>
</div>
...
<div class="col">
<div class="form-group">
<label>Current Password Enter</label>
...
<a href="/todotable">
<button type="button" class="btn btn-primary">Task View </button></a>
</div>
</div>
</div>
</div>
